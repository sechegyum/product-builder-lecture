...
JOBS = [
    ("ahel1.jpg", 1000, 290, "photo-company.jpg", None),   # 2번 카드 · 안텔로페 본사 로비
    ("ahel2.jpg", 1000, 372, "photo-reason.jpg",  None),   # 3번 카드 · 기린클라우드 라이브커머스 스튜디오
]
...
CHIP = {"src": "logo.jpg", "out": "logo-chip.png", "fill": 0.62}
