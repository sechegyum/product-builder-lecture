...
JOBS = []      # 사진 대기 중 — 도착하면 여기 채운다
# ("Fingermotion.jpg", 1000, 290, "photo-company.jpg", None),  # 2번 카드
# ("mobile1.jpg",      1000, 372, "photo-reason.jpg",  None),  # 3번 카드
...
CHIP = {"text": "F", "out": "logo-chip.png"}   # 로고 도착하면 {"src": "logo.jpg", "fill": 0.62}
