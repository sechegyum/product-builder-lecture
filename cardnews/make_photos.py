...
JOBS = [
    ("wyhg-heritage.png", 1000, 290, "photo-company.jpg", (10, 10, 1180, 420)),  # 2번 · 브랜드 역사
    ("wyhg-products.png", 1000, 372, "photo-reason.jpg",  (0,  0, 1173, 470)),   # 3번 · 제품군
    # 2번은 아래 한글 설명 띠를 잘라냈다 — 카드 크기에서는 안 읽힌다.
    # 사진 셋과 금박 서예만 남겨 비를 2.85 로 올렸다.
    # 3번은 '살라미' 제목과 윗줄 제품 넷까지 잘라 비를 2.50 으로 맞췄다.
