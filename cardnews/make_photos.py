...
JOBS = [
    ("snow1.jpg", 1000, 290, "photo-company.jpg", None),  # 2번 카드 · 월드투어 서울 키노트
    ("snow2.jpg", 1000, 372, "photo-reason.jpg",  None),  # 3번 카드 · 펄스애드 파트너 선정
]
...
CHIP = {"src": "snow-logo.jpg", "out": "logo-chip.png", "fill": 0.66}
