...
JOBS = [
    ("aixi-banner.png",  1000, 290, "photo-company.jpg", (0, 150, 1920, 706)),  # 2번 · 브랜드 배너
    ("aixi-patents.png", 1000, 372, "photo-reason.jpg",  (0,  40, 1920, 754)),  # 3번 · AI 칩 그래픽
    # 2번 원본은 1920x780 (비 2.46) 이라 위아래를 잘라 슬롯 비 3.45 에 맞췄다.
    #   'xiao-i' 워드마크 · 한 줄 소개 · NASDAQ: AIXI · 오른쪽 구체가 전부 들어간다.
    # 3번 원본은 1920x763 (비 2.52) 이라 위 40px 만 덜어 비 2.69 로 맞췄다.
    # 4번 · 일봉 캡처 자리. 봉 데이터가 있으면 안 쓴다 — 이번 회차는 실제 봉을 쓴다.
]
