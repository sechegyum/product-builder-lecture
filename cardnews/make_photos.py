...
JOBS = [
    ("xpon1.jpg", 1000, 290, "photo-company.jpg", (0, 20, 340, 220)),  # 2번 카드 · 배터리 (가로로 잘라 크게)
    ("xpon3.jpg", 1000, 372, "photo-reason.jpg",  None),   # 3번 카드 · RV 캠핑
]
...
CHIP = {"src": "xponlogo.jpg", "out": "logo-chip.png", "fill": 1.0}
