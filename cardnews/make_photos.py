...
JOBS = [
    ("mgn-farm.webp",      1000, 290, "photo-company.jpg", (0, 170, 1408, 700)),  # 2번 · 양식장
    ("mgn-dashboard.jpg",  1000, 372, "photo-reason.jpg",  (0,  60, 1006, 600)),  # 3번 · 농장 관리 화면
    # 둘 다 원본 비가 슬롯보다 세로로 길어 그대로 넣으면 전경이 좁게 뜬다.
    # 위아래 여백만 잘라 비를 올렸다 (build 는 높이에 맞춰 확대한다).
    ("mgn-chart.jpg",       1000, 500, "photo-chart.jpg",   (0, 1041, 1195, 1650)),  # 4번 · 토스 일봉 캡처
    # 4번 크롭 — 원본이 폰 화면 전체(1206x2313)라 그대로 넣으면 전경이 240px 로 쪼그라든다.
    # 가격 차트 구간만 잘라 비를 1.96 으로 맞췄다 (슬롯 1000x500 = 2.0).
    # 아래 거래량·MFI 패널은 뺐다 — 넣으면 봉이 다시 작아진다.
]
...
CHIP = {"src": "logo.png", "out": "logo-chip.png", "bleed": True}
