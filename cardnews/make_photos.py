...
JOBS = [
    ("gopro1.jpg", 1000, 290, "photo-company.jpg", (28, 62, 336, 282)),  # 2번 카드 · 히어로4 제품컷 (가로로 잘라 크게)
    ("gopro2.jpg", 1000, 372, "photo-reason.jpg",  (0, 58, 340, 282)),  # 3번 카드 · 수중 촬영 (가로로 잘라 크게)
]
...
CHIP = {"src": "gopro-logo.jpg", "out": "logo-chip.png", "fill": 0.86}
